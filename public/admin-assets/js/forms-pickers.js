...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    ...
    flatpickrDateTimeClass = document.querySelector('.flatpickr-datetime'),
    flatpickrMulti = document.querySelector('#flatpickr-multi'),
    flatpickrRange = document.querySelector('#flatpickr-range'),
    flatpickrRangeClass = document.querySelector('.flatpickr-daterange'),
  ...
  if (flatpickrRangeClass) {
    flatpickrRangeClass.flatpickr({
      enableTime: true,
      dateFormat: 'Y-m-d H:i'
    });
  }
  ...
  // if (typeof flatpickrRangeClass != undefined) {
  //   flatpickrRangeClass.flatpickr({
  //     mode: 'range'
  //   });
  // }
