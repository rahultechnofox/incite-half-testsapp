                        ...
                        @foreach($row->translation as $translation)
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-primary mb-1 mb-sm-0 me-0 me-sm-1" onclick="translateByThirdParty('{{$translation->language->name}}','{{$translation->language->code}}','value_{{$translation->language->code}}');">{{__('lang.translate')}}</button>
                                </div>                        
                            </div>
                        @endforeach
                    @endif
