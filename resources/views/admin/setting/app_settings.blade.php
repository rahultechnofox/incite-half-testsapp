...
@endif -->
<!-- @if($row->key == 'signing_key_android')
<div class="col-md-3 mb-3 display-inline-block width-32-percent mr-10">
    <label class="form-label" for="signing_key_android">{{__('lang.admin_signing_key_android')}}</label>
    <input type="text" class="form-control" value="{{$row->value}}" placeholder="{{__('lang.admin_signing_key_android_placeholder')}}" name="signing_key_android"/>
</div>
@endif
@if($row->key == 'key_property_android')
<div class="col-md-3 mb-3 display-inline-block width-32-percent mr-10">
    <label class="form-label" for="key_property_android">{{__('lang.admin_key_property_android')}}</label>
    <input type="text" class="form-control" value="{{$row->value}}" placeholder="{{__('lang.admin_key_property_android_placeholder')}}" name="key_property_android"/>
</div>
@endif -->
