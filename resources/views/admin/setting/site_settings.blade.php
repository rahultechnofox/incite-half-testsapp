...
<div class="col-md-3 mb-3 display-inline-block width-32-percent mr-10">
    ...
    <select name="layout" class="form-control">
        ...
        <option @if($row->value == 'layout_1') selected  @endif value="layout_1" >{{__('lang.admin_theme_1')}}</option>
        <option @if($row->value == 'layout_2') selected  @endif value="layout_2" >{{__('lang.admin_theme_2')}}</option>
    </select>
</div>
@endif
