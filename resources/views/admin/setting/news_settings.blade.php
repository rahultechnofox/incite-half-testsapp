...
@if($row->key == 'live_news_status')
    <div class="col-md-12 mb-3">
        <div class="form-check form-check-primary mt-3">
            <input class="form-check-input" type="checkbox" name="live_news_status" id="live_news_status" checked="">
...
@if($row->key == 'e_paper_status')
    <div class="col-md-12 mb-3">
        <div class="form-check form-check-primary mt-3">
            <input class="form-check-input" type="checkbox" name="e_paper_status" id="e_paper_status" checked="">
